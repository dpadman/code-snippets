...
public class TestNioFileRead
    ...
    private static void readRawBytes() throws IOException
        {
        final FileInputStream fis = new FileInputStream("/Users/dinoja/Downloads/tempin.txt" );
        ...
        ByteBuffer buffer2 = ByteBuffer.allocate( 1024 * 15 );
        ...
        buffer.get(10);
        showStats( "after dummy get", fc, buffer );
        buffer.get( receive );
        showStats( "after first get", fc, buffer );
        buffer.get( receive );
        showStats( "after second get", fc, buffer );
        buffer2.put(buffer.array(), buffer.position(), buffer.remaining());
        showStats( "after put on second buffer", fc, buffer );
        showStats( "second buffer", fc, buffer2 );
        buffer.position(buffer.position() + buffer.remaining());
        showStats( "after position on second buffer ", fc, buffer );
