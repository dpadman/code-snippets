...
public class FluxAndMonoCombineTest {
	...
	public void combineUsingMerge_With_Delay() {
		...
		StepVerifier.create(mergedFlux)
				.expectSubscription()
				.expectNextCount(6)
				/*.expectNext("A", "B", "C", "D", "E", "F")*/ // fails because A and D arrives together
				.verifyComplete();
	}

	@Test
	public void combineUsingMerge_With_VirtualDelay() {
	...
	@Test
	public void combineUsingConcat_With_VirtualDelay() {
		VirtualTimeScheduler.getOrSet();
